...
const NavBarRecruiter = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-green-700 to-teal-700 shadow-lg px-8 py-4 flex items-center justify-between">
      <div className="flex items-center space-x-8">
        <button
          className="text-3xl font-extrabold text-white hover:text-yellow-300 transition-colors"
          onClick={() => navigate('/recruiter/dashboard')}
        >
          Smart Placement Assistant System - Recruiter
        </button>
      </div>
